...
def create_full_day_children_tab(page: ft.Page, current_user=None):
    """Create and return the full day children tab"""
    ...
    def update_child_table(search_query: str = ""):
        # Get full day children from database using ChildService
    ...
    return ft.Column(
        [
            ft.Row(
                [
                    ft.Text("طلاب اليوم الكامل", size=24, weight=ft.FontWeight.BOLD),
                    add_child_btn,
                ],
            ...
            ft.Text(
                "الطلاب المسجلين في برنامج اليوم الكامل:",
                size=18,
